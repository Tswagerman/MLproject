...
Feed-forward multilayer perceptron with sigmoid activation function trained by backpropagation algorithm. There are two hidden layers with eleven neurons within each eleven neural networks.
